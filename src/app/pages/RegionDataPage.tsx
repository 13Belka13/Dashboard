...
// const filteredRegions = Regions.filter((_region: any, index: number) => message.includes(Regions.край));
// console.log(filteredRegions);

// const filteredRegions = Regions.filter((_region: any, index: number) => Regions[index]["Регион"].includes("Крас"));
// console.log(filteredRegions[0]["Округ"]);
